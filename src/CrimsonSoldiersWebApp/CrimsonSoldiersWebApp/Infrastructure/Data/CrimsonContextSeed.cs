          ...
          private static IEnumerable<Service> GetServices()
          {
               return new List<Service>()
               {
                    new Service()
                    {
                         ...
                         LongDescription = "The IUS Police are Indiana State Troopers that are on the campus and patrolling 24/7. " +
                                           "They also have cadets who control and give out the parking tickets. The police station works " +
                                           "like any other police station when it comes to tickets and reporting crimes. "
                    },
                    ...
                    new Service()
                    {
                         ...
                         ImageUrl = "https://crimsonstorage.blob.core.windows.net/images/writing_center.jpg",
                         ShortDescription = "Get help with writing and revising papers",
                         LongDescription = "The Writing Center provides staff that is readily available to help students with writing essays " +
                                           "and can even help critique ones' resume."
                    },
                    new Service()
                    {
                         Name = "Math Lab",
                         ...
                         ImageUrl = "https://crimsonstorage.blob.core.windows.net/images/math_lab.jpg",
                         ShortDescription = "Get help with math courses and it acts as a location to make up tests",
                         LongDescription = "The Math Lab provides tutors for all math courses to help students with their homework and " +
                                           "giving them more examples to help understand problems. The Math Lab also provides a place to " +
                                           " make up math tests."
                    },
                    new Service()
                    {
                         ...
                         Email = "sessc@ius.edu",
                         ImageUrl = "https://crimsonstorage.blob.core.windows.net/images/student_sucess.png",
                         ShortDescription = "Help students maintain a success path",
                         LongDescription = "The Student Success Center help students learn about different services available on campus. " +
                                           "The center also provides tutoring and testing services."
                    },
                    new Service()
                    {
                         ...
                         ImageUrl = "https://crimsonstorage.blob.core.windows.net/images/computer_science.jpg",
                         ShortDescription = "Get help with Computer Science courses",
                         LongDescription = "The Computer Science tutors are volunteer students who help lower level students with classes " +
                                           "that the tutor is beyond efficient in."
                    },
                    new Service()
                    {
                         Name = "Ogle Center",
                         ...
                         LongDescription = "Ogle Center is location in the Knobview building and has auditoriums that host different plays and " +
                    ...
                    new Service()
                    {
                         ...
                         LongDescription = "Office where all the payments are sent out to all of the students. Students can also visit the office " +
                    ...
                    new Service()
                    {
                         ...
                         Email = "seact@ius.edu",
                         ImageUrl = "https://crimsonstorage.blob.core.windows.net/images/campus_life.jpg",
                         ShortDescription = "Office where students can learn about organizations to get involved in.",
                         LongDescription = "Campus Life provides an office where students can learn about Greek Life and other organizations on " +
                                           "campus. They also act as the judicial board for Greek Life."
                    }, 
                    new Service()
                    {
                         ...
                         LongDescription = "Students can reserve rooms in the UC building and can also ask the staff anything to do with cafeteria" +
                                           "or catering."
                    },
                    new Service()
                    {
                         ...
                         LongDescription = "Students can rent books and reserve rooms in the library to study. It also offers staff and other " +
                    ...
                    new Service()
                    {
                         ...
                         LongDescription = "Housing takes care of everything with the dorms such as assigning rooms, assigning RA's and making " +
                                           "sure everyone is safe and happy."
                    },
                    new Service()
                    {
                         ...
                         LongDescription = "Career Development Center helps students find jobs and internships while also helping students with " +
                                           "their resumes."
                    },
                    new Service()
                    {
                    ...
                    new Service
                    {
                         ...
                         ImageUrl = "https://crimsonstorage.blob.core.windows.net/images/natural_science.jpg",
                    ...
                    new Service
                    {
                         ...
                         ImageUrl = "https://crimsonstorage.blob.core.windows.net/images/social_sciences.jpg",
                    ...
                    new Service
                    {
                         ...
                         LongDescription = "Tech services has staff at a help desk in the 24 hour lab that are readily available for tech questions. " +
                                           "The tech services also has an office that takes on the services that may take a little longer to fix."
                    },
                    new Service
                    {
                    ...
                    new Service
                    {
                         ...
                         LongDescription = "Admissions does everything trying to get students to come to this campus and getting them ready to " +
                    ...
                    new Service
                    {
                         ...
                         LongDescription = "The Language Lab helps and provides students of all levels material to help strengthen their knowledge" +
                                           "of a new language. There are also staff in this office to tutor those who need the extra help."
                    },
                    new Service
                    {
                         Name = "Athletics",
                         ...
                         LongDescription = "The athletics building encompasses the gym and weight training facility. It also provides offices for" +
                                           "the coaching staff for the university."
                    },
                    new Service
                    {
                         Name = "Bookstore",
                         ...
                         LongDescription = "The bookstore is a shop across from the coffee shop that has all the books needed for classes in " +
                                           "one section. Students can also purchase apparel so they can show Grenadier spirit. The bookstore also" +
                                           "has snacks and other items needed for an everyday student."
                    },
                    new Service
                    {
                         ...
                         ImageUrl = "https://crimsonstorage.blob.core.windows.net/images/adult_success.png",
                         ShortDescription = "Office that helps the non-traditonal students",
                         LongDescription = "The Adult Student Center is an office that help non traditional students with the everyday needs of" +
                                           "a student. This is also a place for these students to talk to mentors."
                    }
               };
          }
     }
